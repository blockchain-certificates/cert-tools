...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'create-certificate-template_v3 = cert_tools.create_v3_certificate_template:main',
            'instantiate-certificate-batch = cert_tools.instantiate_v2_certificate_batch:main',
            'instantiate-certificate-batch_v3 = cert_tools.instantiate_v3_certificate_batch:main',
